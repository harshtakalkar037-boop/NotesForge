  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Notes you&apos;ve saved for quick access</p>
      </div>
      <Card>
        <CardContent className="py-20 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">Bookmark notes to find them here quickly</p>
